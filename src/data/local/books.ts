...
const createBook = (
  ...
  // Generate a placeholder cover with a specific color based on difficulty
  const bgColor = difficulty === "easy" ? "A5D6A7" : difficulty === "medium" ? "FFE082" : "EF9A9A";
  const coverUrl = `https://placehold.co/400x600/${bgColor}/333333?text=${encodeURIComponent(title)}`;
